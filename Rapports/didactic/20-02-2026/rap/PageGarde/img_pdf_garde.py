...
png_file = "pagegard_2.png"
pdf_file = "pagegard_2.pdf"
append_images = []
...
# append_images.append(Image.new("RGB", (page_width_px, page_height_px), "white"))
...
img_cropped.save(pdf_file, "PDF", resolution=dpi, save_all=True, append_images=append_images)
