...
\usepackage{times}
\usepackage{setspace}
\usepackage[left=0.4in,right=0.4in,top=0.8in,bottom=0.4in,includefoot,includehead,headheight=13.6pt]{geometry}
...
\usepackage{amsthm} % Pour faciliter l'écriture de théorèmes mathématiques
